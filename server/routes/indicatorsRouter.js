...
router.get('/summary/:agentId/weekly', indicatorsController.getIndicatorsSummary)
   .get('/summary/:agentId/monthly', indicatorsController.getIndicatorsSummary)
   .get('/summary/:agentId/all', indicatorsController.getIndicatorsSummary)
